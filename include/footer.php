...
<div class="container">
    ...
    <div class="row h-100 justify-content-center align-items-center">
            ...
            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
            ...
            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                ...
                <a href="#">Creator Terms of Use</a>
                <a href="#">PO Box 20503 Boulder, CO 80308</a>
                </div>
            </div>

            <div class="col-md-2 copy text-right">
                <h2>Contact Us</h2>
                <p>Support@gidde.com</p>
                <p>Support</p>
                <p>Careers</p>
            </div>

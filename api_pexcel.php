...
$vid = $_POST['vid'];
curl -H "Authorization: 563492ad6f91700001000001f6261981c82c43daa0f0098107766e66" \
  "https://api.pexels.com/v1/search?query=nature&per_page=1"
$api_key="563492ad6f91700001000001f6261981c82c43daa0f0098107766e66";
...
$htm='';
 foreach ($user_data as $user) {
	$htm.='<div class="col-md-3 col-sm-6 mb-3 ">
			...
			<a href="#"><img class="img-fluid" style="height:100px" src="'.$user->previewURL.'" alt=""></a>
			</div>
		</div>
			</div>';
		}

...
function selfInvoker($userId)
{
  ...
  $time=date("h:i sa");
    ...
    */
    ...
    $cmd="ffmpeg -i ".$tempName." ".$filePath;
    echo shell_exec($cmd);
    ...
    //     return;
    // }
    $con = mysqli_connect("localhost", "u9sbt1rw863wi", "c8rusgivnczq", "dbkfagyvgkbifj");
    $sql=mysqli_query($con,"INSERT INTO `audio`( `file`, `name`, `duration`, `user_id`,`type`, `date`, `time`, `status`)
     VALUES ('$fileName','$fileName','','$userId','3','$date','$time','1')");

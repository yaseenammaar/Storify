...
if (isset($_POST['package_submit'])) {
  ...
  $expiry=$_POST['expiry'];
  $qry="UPDATE `user` SET `package`='$package',`package_type`='$type',`expiry`='$expiry'  where id=$hidId";
  $exec=mysqli_query($con,$qry);
  if($exec){
    header('location:users.php?msg=upd');
  }else{
              ...
              <div class="col-lg-3">
                <div class="card position-sticky top-1">
                  <ul class="nav flex-column bg-white border-radius-lg p-3">
                    ...
                    <li class="nav-item pt-2">
                      <a class="nav-link text-body d-flex align-items-center" data-scroll="" href="#package">
                        <i class="ni ni-atom me-2 text-dark opacity-6"></i>
                        <span class="text-sm">Package Details</span>
                      </a>
                    </li>
                    <li class="nav-item pt-2">
              ...
              <div class="col-lg-9 mt-lg-0 mt-4">
                    ...
                    <div class="col-sm-auto col-4">
                      <div class="avatar avatar-xl position-relative">
                        <?php if ($userDetails['photo']==''){ ?>
                              <img id="profileImg" src="../assets/img/user/1.png" alt="<?=$userDetails['name']?>" class="w-100 border-radius-lg shadow-sm">
                        <?php }else{ ?>
                      <img id="profileImg" src="../assets/img/user/<?=$userDetails['photo']?>" alt="<?=$userDetails['name']?>" class="w-100 border-radius-lg shadow-sm">
                    <?php } ?>
                  ...
                  <div class="card-body pt-0">
                    ...
                    <div class="row">
                      <div class="col-12 text-end">
                          <button name="basic" id="basic" type="submit" class="btn btn-outline-dark mg-t-20 btn-sm float-end mt-6 mb-0">Save</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mt-4" id="password">
                  ...
                  <div class="card-body pt-0">
                    ...
                    <button type="submit" name="password_submit" id="password_submit" class="btn btn-outline-dark mg-t-20 btn-sm float-end mt-6 mb-0">Update password</button>
                    </form>
                  </div>

                </div>
                <div class="card mt-4" id="package">
                  <div class="card-header">
                    <h5>Package Details</h5>
                  </div>

                  <div class="card-body pt-0">
                      <form id="package"class="" method="post">
                          <input type="hidden" name="hidId" value="<?=$userDetails['id']?>">
                        <div class="row p-3">
    											<div class="col-md-12 col-sm-12 col-xl-12">
    												<div class="row">
    													<div class="col-12 col-md-4 col-sm-6">
    														<label for="amount">Current Package</label>
    														<select class="form-control" name="package" required>
    															 <option value="">Select package</option>
    																...
    																while($pack=mysqli_fetch_array($qry)){?>
    																 <option <?php if($userDetails['package']==$pack['id']){ ?> selected <?php } ?> value="<?=$pack['id']?>"><?=$pack['name']?></option>
    															 <?php } ?>
    														</select>
    													</div>
    													<div class="col-12 col-md-4 col-sm-6">
    												...
    												<div class="col-12 col-md-4 col-sm-6">
    												 <label for="userlimit">Expiry</label>
    												 <input type="text" name="expiry" id="expiry" required  class="form-control" value="<?=$userDetails['expiry']?>">
    											 </div>

    												</div>
                    <button type="submit" name="package_submit" id="password_submit" class="btn btn-outline-dark mg-t-20 btn-sm float-end mt-6 mb-0">Update Package</button>
                    </form>
                  </div>
                ...
                <div class="card mt-4" id="accounts">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-12 text-end">
                        <input type="submit" name="social_submit" value="Save" class="btn btn-outline-dark mg-t-20 btn-sm float-end mt-4 mb-0">
                      </div>
                    </div>
                      </form>
                  </div>

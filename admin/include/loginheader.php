        ...
        <a class="nav-link pr-0" href="#" role="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
          <div class="media align-items-center">
            <span class="avatar avatar-sm rounded-circle">
              ...
              <?php }else{ ?>
            <img alt="Image placeholder" src="../assets1/img/user/<?=$adminDetails['photo']?>">
          <?php } ?>
            </span>
            <div class="media-body ml-2  d-none d-lg-block">
              <span class="mb-0 text-sm  font-weight-bold text-white"><?=$adminDetails['name']?></span>
            </div>
          </div>
        </a>
        <div class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton2">
          <div class="dropdown-header noti-title">
            <h6 class="text-overflow m-0">Welcome! <?=$adminDetails['name']?></h6>
          </div>

(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[888], {
		2924: function(o, i, f) {
			"use strict";
			var p = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0 !== f.g ? f.g : "undefined" != typeof self ? self : {};
			...
			var h = b(function(c, a) {
				...
				Object.defineProperty(a, "__esModule", {
					value: !0
				}), a.INLINES = void 0, (b = a.INLINES || (a.INLINES = {})).HYPERLINK = "hyperlink", b.ENTRY_HYPERLINK = "entry-hyperlink", b.ASSET_HYPERLINK = "asset-hyperlink", b.EMBEDDED_ENTRY = "embedded-entry-inline"
			});
			a(h), h.INLINES;
			var j = b(function(d, c) {
				...
				Object.defineProperty(c, "__esModule", {
					value: !0
				}), (a = b || (b = {})).BOLD = "bold", a.ITALIC = "italic", a.UNDERLINE = "underline", a.CODE = "code", c.default = b
			});
			a(j);
			var c = b(function(d, a) {
				var b, c = p && p.__spreadArray || function(d, b, e) {
				...
				Object.defineProperty(a, "__esModule", {
					value: !0
				}), a.V1_NODE_TYPES = a.TEXT_CONTAINERS = a.HEADINGS = a.CONTAINERS = a.VOID_BLOCKS = a.TABLE_BLOCKS = a.LIST_ITEM_BLOCKS = a.TOP_LEVEL_BLOCKS = void 0, a.TOP_LEVEL_BLOCKS = [g.BLOCKS.PARAGRAPH, g.BLOCKS.HEADING_1, g.BLOCKS.HEADING_2, g.BLOCKS.HEADING_3, g.BLOCKS.HEADING_4, g.BLOCKS.HEADING_5, g.BLOCKS.HEADING_6, g.BLOCKS.OL_LIST, g.BLOCKS.UL_LIST, g.BLOCKS.HR, g.BLOCKS.QUOTE, g.BLOCKS.EMBEDDED_ENTRY, g.BLOCKS.EMBEDDED_ASSET, g.BLOCKS.TABLE, ], a.LIST_ITEM_BLOCKS = [g.BLOCKS.PARAGRAPH, g.BLOCKS.HEADING_1, g.BLOCKS.HEADING_2, g.BLOCKS.HEADING_3, g.BLOCKS.HEADING_4, g.BLOCKS.HEADING_5, g.BLOCKS.HEADING_6, g.BLOCKS.OL_LIST, g.BLOCKS.UL_LIST, g.BLOCKS.HR, g.BLOCKS.QUOTE, g.BLOCKS.EMBEDDED_ENTRY, g.BLOCKS.EMBEDDED_ASSET, ], a.TABLE_BLOCKS = [g.BLOCKS.TABLE, g.BLOCKS.TABLE_ROW, g.BLOCKS.TABLE_CELL, g.BLOCKS.TABLE_HEADER_CELL, ], a.VOID_BLOCKS = [g.BLOCKS.HR, g.BLOCKS.EMBEDDED_ENTRY, g.BLOCKS.EMBEDDED_ASSET], a.CONTAINERS = ((b = {})[g.BLOCKS.OL_LIST] = [g.BLOCKS.LIST_ITEM], b[g.BLOCKS.UL_LIST] = [g.BLOCKS.LIST_ITEM], b[g.BLOCKS.LIST_ITEM] = a.LIST_ITEM_BLOCKS, b[g.BLOCKS.QUOTE] = [g.BLOCKS.PARAGRAPH], b[g.BLOCKS.TABLE] = [g.BLOCKS.TABLE_ROW], b[g.BLOCKS.TABLE_ROW] = [g.BLOCKS.TABLE_CELL, g.BLOCKS.TABLE_HEADER_CELL], b[g.BLOCKS.TABLE_CELL] = [g.BLOCKS.PARAGRAPH], b[g.BLOCKS.TABLE_HEADER_CELL] = [g.BLOCKS.PARAGRAPH], b), a.HEADINGS = [g.BLOCKS.HEADING_1, g.BLOCKS.HEADING_2, g.BLOCKS.HEADING_3, g.BLOCKS.HEADING_4, g.BLOCKS.HEADING_5, g.BLOCKS.HEADING_6, ], a.TEXT_CONTAINERS = c([g.BLOCKS.PARAGRAPH], a.HEADINGS, !0), a.V1_NODE_TYPES = [g.BLOCKS.DOCUMENT, g.BLOCKS.PARAGRAPH, g.BLOCKS.HEADING_1, g.BLOCKS.HEADING_2, g.BLOCKS.HEADING_3, g.BLOCKS.HEADING_4, g.BLOCKS.HEADING_5, g.BLOCKS.HEADING_6, g.BLOCKS.OL_LIST, g.BLOCKS.UL_LIST, g.BLOCKS.LIST_ITEM, g.BLOCKS.HR, g.BLOCKS.QUOTE, g.BLOCKS.EMBEDDED_ENTRY, g.BLOCKS.EMBEDDED_ASSET, h.INLINES.HYPERLINK, h.INLINES.ENTRY_HYPERLINK, h.INLINES.ASSET_HYPERLINK, h.INLINES.EMBEDDED_ENTRY, "text", ]
			});
			a(c), c.V1_NODE_TYPES, c.TEXT_CONTAINERS, c.HEADINGS, c.CONTAINERS, c.VOID_BLOCKS, c.TABLE_BLOCKS, c.LIST_ITEM_BLOCKS, c.TOP_LEVEL_BLOCKS;
			...
			var e = b(function(b, a) {
				...
				Object.defineProperty(a, "__esModule", {
					value: !0
				}), a.isText = a.isBlock = a.isInline = void 0, a.isInline = function(a) {
			...
			var d = b(function(i, a) {
				var n = p && p.__createBinding || (Object.create ? function(e, c, d, b) {
						void 0 === b && (b = d);
						var a = Object.getOwnPropertyDescriptor(c, d);
						(!a || ("get" in a ? !c.__esModule : a.writable || a.configurable)) && (a = {
							enumerable: !0,
							get: function() {
								return c[d]
							}
					...
					o = p && p.__setModuleDefault || (Object.create ? function(a, b) {
					...
					b = p && p.__exportStar || function(b, c) {
						for (var a in b) "default" === a || Object.prototype.hasOwnProperty.call(c, a) || n(c, b, a)
					},
					d = p && p.__importStar || function(a) {
						if (a && a.__esModule) return a;
						var b = {};
						if (null != a)
							for (var c in a) "default" !== c && Object.prototype.hasOwnProperty.call(a, c) && n(b, a, c);
						return o(b, a), b
					},
					q = p && p.__importDefault || function(a) {
				...
				Object.defineProperty(a, "__esModule", {
					value: !0
				}), a.helpers = a.EMPTY_DOCUMENT = a.MARKS = a.INLINES = a.BLOCKS = void 0, Object.defineProperty(a, "BLOCKS", {
					enumerable: !0,
					get: function() {
						return g.BLOCKS
					}
				...
				}), b(c, a), b(k, a), b(l, a), Object.defineProperty(a, "EMPTY_DOCUMENT", {
					enumerable: !0,
					get: function() {
						return q(m).default
					}
			...
			function n(a, b) {
				return (void 0 === b && (b = " "), a && a.content) ? a.content.reduce(function(d, c, f) {
					if (q.isText(c)) g = c.value;
					else if ((q.isBlock(c) || q.isInline(c)) && !(g = n(c, b)).length) return d;
					var g, e = a.content[f + 1];
		...
		8509: function(e, b, c) {
			...
			var f = "undefined" != typeof window && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || "MacIntel" === window.navigator.platform && window.navigator.maxTouchPoints > 1),
				...
				m = function(b) {
					...
					return !!l(a.target) || a.touches.length > 1 || (a.preventDefault && a.preventDefault(), !1)
				},
				n = function(a) {
					if (void 0 === k) {
						var c = !!a && !0 === a.reserveScrollBarGap,
							b = window.innerWidth - document.documentElement.clientWidth;
						c && b > 0 && (k = document.body.style.paddingRight, document.body.style.paddingRight = b + "px")
					}
					void 0 === j && (j = document.body.style.overflow, document.body.style.overflow = "hidden")
				},
				o = function() {
					void 0 !== k && (document.body.style.paddingRight = k, k = void 0), void 0 !== j && (document.body.style.overflow = j, j = void 0)
				},
				p = function(a, c) {
					var b, d = a.targetTouches[0].clientY - i;
					return !l(a.target) && (c && 0 === c.scrollTop && d > 0 ? m(a) : (b = c) && b.scrollHeight - b.scrollTop <= b.clientHeight && d < 0 ? m(a) : (a.stopPropagation(), !0))
				},
				q = function(a, b) {
					if (!a) {
						...
						targetElement: a,
						options: b || {}
					}]), f ? (a.ontouchstart = function(a) {
						1 === a.targetTouches.length && (i = a.targetTouches[0].clientY)
					}, a.ontouchmove = function(b) {
						1 === b.targetTouches.length && p(b, a)
					}, h || (document.addEventListener("touchmove", m, d ? {
						passive: !1
					} : void 0), h = !0)) : n(b))
				},
				r = function() {
					f ? (g.forEach(function(a) {
						a.targetElement.ontouchstart = null, a.targetElement.ontouchmove = null
					}), h && (document.removeEventListener("touchmove", m, d ? {
						passive: !1
					} : void 0), h = !1), i = -1) : o(), g = []
				},
				s = function(a) {
					...
					g = g.filter(function(b) {
						return b.targetElement !== a
					}), f ? (a.ontouchstart = null, a.ontouchmove = null, h && 0 === g.length && (document.removeEventListener("touchmove", m, d ? {
						passive: !1
					} : void 0), h = !1)) : g.length || o()
				}
		},
		4184: function(a, b) {
			var c, d;
		...
		3454: function(d, e, a) {
			"use strict";
			var b, c;
			d.exports = (null === (b = a.g.process) || void 0 === b ? void 0 : b.env) && "object" == typeof(null === (c = a.g.process) || void 0 === c ? void 0 : c.env) ? a.g.process : a(7663)
		},
		1118: function(a, b, c) {
				...
				c = function(a) {
					var e = a.className,
						...
						c = (0, n.oR)(function(a) {
							...
							return {
								hubSpotScriptLoaded: b,
								setHubSpotScriptLoaded: c
							}
						}),
						d = c.hubSpotScriptLoaded,
						r = c.setHubSpotScriptLoaded,
						p = (0, k.useCallback)(function(a) {
							console.info("HubSpot Form ".concat(a, " is ready")), "function" == typeof i && i(q)
						}, [i]);
					return (0, k.useEffect)(function() {
						!d || (null == q ? void 0 : q.current) || (q.current = window.hbspt.forms.create({
							target: "#id-".concat(b),
							region: f,
							portalId: g,
							formId: b,
					...
					}, [d, b, f, g, h, p, ]), (0, j.jsxs)("div", {
						className: l()(o().root, e),
						children: [!d && (0, j.jsx)(m(), {
		...
		2167: function(n, h, b) {
			...
			function t(a, c) {
				if (a) {
					...
					if ("Arguments" === b || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(b)) return r(a, c)
				}
			}
			var l = {
					arrowLeft: {
						...
						shape: (0, a.jsx)("g", {
							...
							children: (0, a.jsx)("polygon", {
								points: "20.5 10.657 6.914 10.657 10.864 6.707 9.45 5.293 3.086 11.657 9.45 18.021 10.864 16.606 6.914 12.657 20.5 12.657 20.5 10.657"
							})
						})
					},
					arrowRight: {
						...
						shape: (0, a.jsx)("g", {
							fill: "currentColor",
							children: (0, a.jsx)("polygon", {
								points: "15.551 5.293 14.137 6.707 18.086 10.657 4.5 10.657 4.5 12.657 18.086 12.657 14.137 16.606 15.551 18.021 21.914 11.657 15.551 5.293"
							})
						})
					},
					chevronDown: {
						...
						shape: (0, a.jsx)("g", {
							fill: "currentColor",
							children: (0, a.jsx)("polygon", {
								points: "11.657 16.228 5.293 9.864 6.707 8.45 11.657 13.399 16.606 8.45 18.021 9.864 11.657 16.228"
							})
						})
					},
					filter: {
		...
		3697: function(i, d, a) {
			...
			var c = e.forwardRef(function(a, d) {
				...
				return e.createElement(f, function(d) {
					for (var a = 1; a < arguments.length; a++) {
						var c = null != arguments[a] ? arguments[a] : {},
							b = Object.keys(c);
						"function" == typeof Object.getOwnPropertySymbols && (b = b.concat(Object.getOwnPropertySymbols(c).filter(function(a) {
					...
					ref: d,
					className: (void 0 === b || (c = b) && "undefined" != typeof Symbol && c.constructor, j()(k()[b], g))
				}, i), h)
			});
			c.propTypes = {
				as: b().string,
				...
				return (0, d.useEffect)(function() {
					var b = h || 0,
						...
						f = function() {
							...
							Math.abs(a - c) >= b && (j(a > c ? e : "up"), c = a > 0 ? a : 0), d = !1
						},
						a = function() {
		...
		3828: function(z, e, a) {
			...
			var H = function(a) {
					...
					window.dataLayer && window.dataLayer.push(function(d) {
						for (var a = 1; a < arguments.length; a++) {
							var c = null != arguments[a] ? arguments[a] : {},
								b = Object.keys(c);
							"function" == typeof Object.getOwnPropertySymbols && (b = b.concat(Object.getOwnPropertySymbols(c).filter(function(a) {
				...
				J = "\n    (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':\n    new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],\n    j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=\n    'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);\n    })(window,document,'script','dataLayer','".concat("GTM-NL4KXHD", "');\n"),
				K = function() {
					var a = (0, B.useRouter)();
					return (0, k.useEffect)(function() {
						var b = function(a) {
						...
						return a.events.on("routeChangeComplete", b),
							function() {
			...
			var N = function() {
				...
				P = function() {
					var a = O.env.ONE_TRUST_ID,
						b = (0, D.oR)(function(a) {
							return {
								setOneTrustState: a.setOneTrustState
							}
						}).setOneTrustState;
					return ((0, k.useEffect)(function() {
						var c, d = Date.now(),
							e = function() {
								b(window.OneTrust.IsAlertBoxClosed() ? "closed" : "open", window.OnetrustActiveGroups.split(",").filter(function(a) {
									return !!a
								}))
							},
							a = function() {
								void 0 === window.OneTrust ? Date.now() - d < 1e4 && (c = requestAnimationFrame(a)) : (c = void 0, e(), window.OneTrust.OnConsentChanged(function() {
									return e()
								}))
							};
						return a(),
					...
					}, [b]), a) ? (0, A.jsxs)(A.Fragment, {
						children: [(0, A.jsx)(F(), {
							strategy: "beforeInteractive",
							src: "https://cdn.cookielaw.org/consent/".concat(a, "/OtAutoBlock.js")
						}), (0, A.jsx)(F(), {
							strategy: "beforeInteractive",
			...
			var f = function(c) {
				var a, b, h = c.title,
					...
					e = (a = (0, Y.Z)(), b = 2, function(a) {
						...
						if (a) {
							...
							var b = Object.prototype.toString.call(a).slice(8, -1);
							if ("Object" === b && a.constructor && (b = a.constructor.name), "Map" === b || "Set" === b) return Array.from(b);
							if ("Arguments" === b || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(b)) return _(a, c)
						}
					}(a, b) || function() {
						throw new TypeError("Invalid attempt to destructure non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
					}()),
				...
				return (0, k.useEffect)(function() {
					var a = d.current;
					return a && (a.addEventListener("focusin", m), a.addEventListener("focusout", n)),
						function() {
							a && (a.removeEventListener("focusin", m), a.removeEventListener("focusout", n))
						}
				}, [d, m, n]), (0, A.jsxs)("section", {
					ref: d,
					className: $().root,
					children: [(0, A.jsxs)(V.Z, {
						...
						style: {
							"--panel-height": "".concat(l, "px")
						},
						children: (0, A.jsx)("ul", {
							ref: j,
							children: i.map(function(a, b) {
								return (0, A.jsx)(ac, ab({}, a), "".concat(h, "-").concat(b))
							})
						})
					})]
				})
			...
			var ac = function(a) {
					...
					return (0, A.jsx)("li", {
						children: (0, A.jsx)(R(), {
							href: g,
							children: (0, A.jsxs)("a", ab({}, h, {
								children: [c, (0, A.jsx)(Z.Z, {
									className: $().hint,
									label: e,
									color: f
								})]
			...
			var d = function(a) {
				var b, d, n = a.label,
					...
					j = (b = (0, Y.Z)(), d = 2, function(a) {
						...
						if (a) {
							...
							var b = Object.prototype.toString.call(a).slice(8, -1);
							if ("Object" === b && a.constructor && (b = a.constructor.name), "Map" === b || "Set" === b) return Array.from(b);
							if ("Arguments" === b || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(b)) return aq(a, c)
						}
					}(b, d) || function() {
						throw new TypeError("Invalid attempt to destructure non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
					}()),
				...
				(0, k.useEffect)(function() {
					...
					return a && (a.addEventListener("focusin", b), a.addEventListener("focusout", d), c && (a.addEventListener("mouseenter", b), a.addEventListener("mouseleave", d))), C.events.on("routeChangeStart", e),
						function() {
							a && (a.removeEventListener("mouseenter", b), a.removeEventListener("mouseleave", d), a.removeEventListener("focusin", b), a.removeEventListener("focusout", d)), C.events.off("routeChangeStart", e)
						}
				}, [C.events, c, l, g, t]);
				var E = (0, k.useCallback)(function() {
					f && c && (H(!1), g(!1))
				}, [c, f, g]);
				(0, k.useEffect)(function() {
			...
			var av = function(a) {
				...
				h = function(c) {
					...
					return (0, k.useEffect)(function() {
						var a = g.current;
						return window.addEventListener("keyup", l), a && (a.addEventListener("focusin", n), a.addEventListener("focusout", o)),
							function() {
								window.removeEventListener("keyup", l), a.removeEventListener("focusin", n), a.removeEventListener("focusout", o)
							}
					}, [g, l]), (0, A.jsxs)("button", {
						ref: g,
						className: Q()(ay().root, i, (a = {}, b = ay().isOpen, d = f, b in a ? Object.defineProperty(a, b, {
							value: d,
							enumerable: !0,
							configurable: !0,
							writable: !0
			...
			var i = function(c) {
				...
				return (0, k.useEffect)(function() {
					return m.events.on("routeChangeStart", r),
						function() {
							m.events.off("routeChangeStart", r)
						}
				}, [m.events]), (0, k.useEffect)(function() {
					return b ? (0, al.Qp)(i.current) : (0, al.tG)(i.current),
						function() {
							(0, al.tP)()
						}
				}, [b]), (0, A.jsxs)("header", {
					className: Q()(aA().root, (aB(a = {}, aA().isOpen, b), aB(a, aA().isHidden, n === am.gN), a)),
					children: [(0, A.jsx)(R(), {
						href: "/",
						children: (0, A.jsx)("a", {
							className: aA().logo,
							children: (0, A.jsx)(T, {
								ariaId: "finix-logo-header"
							})
						})
					}), (0, A.jsx)(az, {
						className: aA().toggle,
						...
						children: (0, A.jsxs)("div", {
							...
							children: [(0, A.jsxs)("ul", {
								...
								children: [h.map(function(a, b) {
									...
									return "HeaderNavItemLink" == d ? (0, k.createElement)(aD, aC({}, c, {
										key: b,
										className: aA().navItem,
										anchorClassName: aA().navItemAnchor
									})) : (0, k.createElement)(ax, aC({}, c, {
										key: b,
										as: "li",
										setIsPanelOpen: p,
										setPanelHeight: q,
									...
									className: Q()(aA().panelBackground, aB({}, aA().isOpen, j))
								})]
							}), (0, A.jsx)("div", {
			...
			var aG = a(2860),
				aH = function() {
					...
					return a[0], a[1], (0, k.useEffect)(function() {
						var a = function(a) {};
						return document.addEventListener("keypress", a),
							function() {
			...
			var aM = function() {
				...
				aN = function(b) {
					var f = b.Component,
						...
						g = (0, B.useRouter)();
					return (0, k.useEffect)(function() {
						console.info("%c \uD83D\uDCB3 finix.com | v".concat(aJ.i8), "font: bold 12px sans-serif; color: #0052e5; display: block; width: 100%;")
					}, []), C(), (0, A.jsxs)(D.zt, {
						createStore: (0, D.ZP)(e),
						children: [(0, A.jsx)(aM, {}), (0, A.jsx)(K, {}), (0, A.jsx)(N, {}), (0, A.jsx)(P, {}), c && (0, A.jsx)(aE, aL({}, c)), (0, A.jsxs)("div", {
							className: aI().wrapper,
							children: [(0, A.jsx)("main", {
								className: aI().main,
								children: (0, k.createElement)(f, aL({}, e, {
									key: g.asPath
								}))
							}), d && (0, A.jsx)(ak, aL({}, d))]
						}), (0, A.jsx)(W.$x, {}), (0, A.jsx)(aH, {})]
					})
				}
		},
		558: function(c, b, a) {
			...
			var k = function(a) {
				...
				l = function(a) {
					...
					return d || "/" === a.charAt(0) || (b.href = "/" + a), e && !a.startsWith("mailto:") && (b.href = "mailto:" + a), b
				};

			function m(a) {
				var b, c, e = (null == a ? void 0 : null === (b = a.headline) || void 0 === b ? void 0 : b.json) ? (0, d.a)(a.headline.json) : null,
					f = (null == a ? void 0 : null === (c = a.description) || void 0 === c ? void 0 : c.json) ? (0, d.a)(a.description.json) : null,
					g = (null == a ? void 0 : a.image) && !((null == a ? void 0 : a.webmVideo) || (null == a ? void 0 : a.mp4Video)) ? a.image : null;
				return {
					title: e,
					description: f,
					image: g
			...
			function t(d) {
				var a = function(a) {
					...
					if (a.match(n)) return s.includes(a.slice(1)) ? {
						type: "external",
						url: "https://finix.com".concat(a)
					} : {
						type: "internal",
						url: a
					};
		...
		3034: function(f, d, a) {
			...
			var b = a(7294);
			let e = "undefined" == typeof window || !window.navigator || /ServerSideRendering|^Deno\//.test(window.navigator.userAgent),
			...
			var c = function() {
					...
					return {
						Provider({
							...
							let d = (0, b.useRef)();
							return d.current || (e && (console.warn("Provider initialStore is deprecated and will be removed in the next version."), c || (c = () => e)), d.current = c()), (0, b.createElement)(a.Provider, {
								value: d.current
							}, f)
						},
						useStore(d, e = Object.is) {
							let c = (0, b.useContext)(a);
							if (!c) throw new Error("Seems like you have not used zustand provider as an ancestor.");
							return c(d, e)
						},
						useStoreApi() {
							let c = (0, b.useContext)(a);
						...
						return function(a) {
							let d = "function" == typeof a ? function(d) {
									let e, h = new Set,
										a = (a, c) => {
											...
											if (b !== e) {
												let d = e;
												e = c ? b : Object.assign({}, e, b), h.forEach(a => a(e, d))
											}
										},
										b = () => e,
										i = (d, a = b, f = Object.is) => {
										...
										f = (a, b, c) => b || c ? i(a, b, c) : (h.add(a), () => h.delete(a)),
										g = () => h.clear(),
										c = {
											setState: a,
											getState: b,
								...
								c = (c = d.getState, f = Object.is) => {
									let [, o] = (0, b.useReducer)(a => a + 1, 0), a = d.getState(), k = (0, b.useRef)(a), l = (0, b.useRef)(c), m = (0, b.useRef)(f), n = (0, b.useRef)(!1), e = (0, b.useRef)();
									void 0 === e.current && (e.current = c(a));
									let h, i = !1;
									(k.current !== a || l.current !== c || m.current !== f || n.current) && (h = c(a), i = !f(e.current, h)), g(() => {
										i && (e.current = h), k.current = a, l.current = c, m.current = f, n.current = !1
									});
									let p = (0, b.useRef)(a);
									g(() => {
										let a = () => {
												try {
													let a = d.getState(),
														b = l.current(a);
													m.current(e.current, b) || (k.current = a, e.current = b, o())
												} catch (c) {
													n.current = !0, o()
												}
											},
							...
							return {
								...
								setStoryIndustries: function(b) {
									return a({
										allStoryIndustries: b
									})
								},
								setHubSpotScriptLoaded: function() {
									return a({
										hubSpotScriptLoaded: !0
									})
								},
								setChiliPiperScriptLoaded: function() {
									return a({
										chiliPiperScriptLoaded: !0
									})
								},
		...
		5452: function(a) {
			a.exports = {
				...
				resourceRichTextModuleHeadline: "Text_resourceRichTextModuleHeadline__7dbTu",
		...
		8921: function(a) {
			a.exports = {
				wrapper: "app_wrapper__TPBf3",
				main: "app_main__R8ziC"
			}
		},
		4533: function(a) {
			a.exports = {
				container: "grid_container__ZwXiO"
			}
		},
		584: function() {},
		7091: function() {},
			...
			a.exports = function(b) {
				...
				var d = function(b) {
						function a(c) {
							...
							return b.addMainScript = b.addMainScript.bind(b), b.addAttributes = b.addAttributes.bind(b), b.addEventHandlers = b.addEventHandlers.bind(b), b.insertScript = b.insertScript.bind(b), b.createStyleString = b.createStyleString.bind(b), b.addCustomStyle = b.addCustomStyle.bind(b), b
						}
						return function(b, a) {
							...
							value: function(b) {
								...
								a.innerText = b, a.async = !0, document.body.appendChild(a)
							}
						}, {
							key: "addMainScript",
							value: function() {
							...
							value: function() {
								var a = "";
								void 0 !== this.props.userId ? (a = "\n        var t = window.driftt = window.drift = window.driftt || [];\n        drift.identify('" + this.props.userId + "', " + JSON.stringify(this.props.attributes) + ")\n      ", this.insertScript(a)) : this.props.attributes && (a = "\n        drift.on('ready', function() {\n          drift.api.setUserAttributes(" + JSON.stringify(this.props.attributes) + ")\n        })\n      ", this.insertScript(a))
							}
						}, {
							key: "addEventHandlers",
							value: function() {
								var a = this;
								this.props.eventHandlers && Array.isArray(this.props.eventHandlers) && this.props.eventHandlers.forEach(function(b) {
									var c = "\n        drift.on('" + b.event + "', " + b.function+");\n        ";
									a.insertScript(c)
								})
							}
						}, {
							...
							value: function() {
								var a = this;
								return Object.keys(this.props.style).reduce(function(c, b) {
							...
							value: function() {
								if (this.props.style) {
									...
									document.head.appendChild(a), a.innerText = "\n        iframe#drift-widget {\n          " + this.createStyleString() + "\n        }\n      "
								}
							}
						}, {
							key: "componentDidMount",
							value: function() {
								"undefined" == typeof window || window.drift || (this.addMainScript(), this.addAttributes(), this.addEventHandlers(), this.addCustomStyle())
							}
						}, {
							key: "render",
							value: function() {
				...
				function G(b, c, d, e) {
					if (F.length) {
						var a = F.pop();
						return a.result = b, a.keyPrefix = c, a.func = d, a.context = e, a.count = 0, a
					}
					return {
						result: b,
						keyPrefix: c,
				...
				function H(a) {
					a.result = null, a.keyPrefix = null, a.func = null, a.context = null, a.count = 0, 10 > F.length && F.push(a)
				}

				function I(a, b, c) {
					return null == a ? 0 : function i(a, d, g, h) {
						var b = typeof a;
						...
						if (c = 0, d = "" === d ? "." : d + ":", Array.isArray(a))
							for (var e = 0; e < a.length; e++) {
								var f = d + J(b = a[e], e);
								c += i(b, f, g, h)
							} else if ("function" == typeof(f = null === a || "object" != typeof a ? null : "function" == typeof(f = y && a[y] || a["@@iterator"]) ? f : null))
								for (a = f.call(a), e = 0; !(b = a.next()).done;) c += i(b = b.value, f = d + J(b, e++), g, h);
							else if ("object" === b) throw Error(z(31, "[object Object]" == (g = "" + a) ? "object with keys {" + Object.keys(a).join(", ") + "}" : g, ""));
						return c
					}(a, "", b, c)
				}
				...
				function L(a, c, d) {
					var b, e, f = a.result,
						g = a.keyPrefix;
					a = a.func.call(a.context, c, a.count++), Array.isArray(a) ? M(a, f, d, function(a) {
						return a
					}) : null != a && (o(a) && (a = (b = a, e = g + (!a.key || c && c.key === a.key ? "" : ("" + a.key).replace(E, "$&/") + "/") + d, {
						$$typeof: r,
						type: b.type,
						key: e,
						ref: b.ref,
				...
				function M(d, a, b, e, f) {
					var c = "";
					null != b && (c = ("" + b).replace(E, "$&/") + "/"), I(d, L, a = G(a, c, e, f)), H(a)
				}
				var p = {
					current: null
				};
				...
				a.Children = {
				...
				}, a.Component = c, a.Fragment = i, a.Profiler = k, a.PureComponent = d, a.StrictMode = j, a.Suspense = l, a.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = {
					...
					var d = f({}, a.props),
						...
						j = a._owner;
					if (null != b) {
						if (void 0 !== b.ref && (i = b.ref, j = m.current), void 0 !== b.key && (h = "" + b.key), a.type && a.type.defaultProps) var c = a.type.defaultProps;
				...
				}, a.createElement = n, a.createFactory = function(a) {
					var b = n.bind(null, a);
					return b.type = a, b
				...
				}, a.isValidElement = o, a.lazy = function(a) {
					return {
						$$typeof: x,
						_ctor: a,
						_status: -1,
				...
				a.exports = ! function() {
					...
					for (var a, b, g = function(a) {
							if (null == a) throw new TypeError("Object.assign cannot be called with null or undefined");
							return Object(a)
						}(j), h = 1; h < arguments.length; h++) {
						for (var i in a = Object(arguments[h])) e.call(a, i) && (g[i] = a[i]);
						if (d) {
							b = d(a);
							for (var c = 0; c < b.length; c++) f.call(a, b[c]) && (g[b[c]] = a[b[c]])
						}
					}
					return g
				} : Object.assign
		...
		3047: function(e, d, a) {
			...
			var b = a(7294),
				...
				h = c.jU && void 0 !== window.ResizeObserver ? function() {
		...
		4829: function(c, b, a) {
			...
			var d = a(7294),
				e = a(6362);
			b.Z = function(a, g) {
				var b, c, f = (0, d.useState)((b = a, void 0 !== (c = g) ? c : !!e.jU && window.matchMedia(b).matches)),
					h = f[0],
					i = f[1];
				return (0, d.useEffect)(function() {
					var d = !0,
					...
					return b.addListener(c), i(b.matches),
						function() {
